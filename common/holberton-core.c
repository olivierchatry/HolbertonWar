...
static opcode_t g_opcodes[] = {
	...
	{ HCORE_FORK_OPCODE, "fork", ASM_PROCESSING_NO_TYPES, HCORE_FORK_CYCLES, 1, {
			OP_ARG_TYPE_IMM
		}
	},
	...
	{ HCORE_LFORK_OPCODE, "lfork", ASM_PROCESSING_NO_MOD|ASM_PROCESSING_NO_TYPES, HCORE_LFORK_CYCLES, 1, {
			OP_ARG_TYPE_IMM
		}
	},
